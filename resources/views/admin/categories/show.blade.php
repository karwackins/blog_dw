            ...
            <div class="container-fluid mt-5">
                ...
                <div class="card mb-4 wow fadeIn">
                    ...
                    <div class="card-body d-sm-flex justify-content-between">
                        ...
                        @include('admin.categories.message')
                ...
                <div class="row wow fadeIn">
                    <div class="col-md-6 mb-4">
                        <label for=""><strong>Dodaj nową kategorię</strong></label>
                        <form action="{{ url('/panel/categories') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <!--Grid row-->
                            <div class="row wow fadeIn">
                                <div class="col-md-12 mb-4">
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="" placeholder="Nazwa kategorii" value="{{ old('name') }}">
                                    @error('name')
                                    ...
                                    <br>
                                        <div class="col-md-12">
                                            ...
                                            <button type="submit" class="btn btn-success">Dodaj kategorie</button>
                                        </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($categories as $category)
                                <tr style="vertical-align: middle">
                                    ...
                                    <td>
                                        <div class="row">
                                            <a href="{{ url('/panel/categories/'.$category->id.'/edit') }}" class="btn btn-sm btn-primary" style="padding-right: 23.60; margin: .375rem;"><i class="far fa-edit"></i></a>
                                        </div>
                                        <div class="row">
                                            <form action="{{ url('/panel/categories/'.$category->id) }}" method="POST">
                                                {{ csrf_field() }}
                                                {{method_field('DELETE')}}
