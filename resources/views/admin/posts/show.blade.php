            ...
            <div class="container-fluid mt-5">
                ...
                <div class="row wow fadeIn">
                    ...
                    <div class="col-md-9 mb-4">
                        <a href="{{ url('/panel/posts/create') }}" type="button" class="btn btn-primary btn-sm">Dodaj wpis
                        </a>
                        <table class="table">
                            <thead>
                            <tr>
                            ...
                            @foreach($posts as $post)
                                <tr style="vertical-align: middle">
                                    ...
                                    <td style="vertical-align: middle">{{ $post->publish }}</td>
                                    <td>
                                        <a href="{{ url('/panel/posts/'.$post->id.'/edit') }}" class="btn btn-sm btn-primary"><i class="far fa-edit"></i></a>
                                        <form action="{{ url('/panel/posts/'.$post->id) }}" method="POST">
                                            {{ csrf_field() }}
                                            {{method_field('DELETE')}}
